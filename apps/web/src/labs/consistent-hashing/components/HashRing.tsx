...
export function HashRing({ ringSize, nodes, activeMessages }: HashRingProps) {
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center scale-[0.65] sm:scale-75 md:scale-90 lg:scale-100 origin-center transition-transform">
      <svg width={center * 2} height={center * 2} className="overflow-visible">
        ...
        <circle 
          ...
          cy={center} 
          r={radius} 
          className="fill-none stroke-stone-900 stroke-3" 
        />
          ...
          return (
            <g key={`slot-${i}`}>
              ...
              <text
                ...
                className="font-mono text-[10px] fill-stone-400 font-bold"
              >
                {i}
              </text>
            </g>
          ...
          return (
            ...
            >
              ...
              <text 
                ...
                textAnchor="middle" 
                alignmentBaseline="middle"
                className="font-mono text-xs font-black fill-stone-900"
              >
                {node.name}
              </text>
              <text 
                ...
                y={y + 12} 
                textAnchor="middle" 
                className="font-mono text-[10px] fill-stone-500 font-bold"
              >
                h:{node.hash}
              </text>
            </motion.g>
